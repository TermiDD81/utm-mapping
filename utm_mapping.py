...
('korsakov', 'ЖК Анапа Корсаков'),
('vysokom', 'ЖК Анапа На высоком берегу'),
]
...
('korsakov', 'ЖК Корсаков'),
('vysokom', 'ЖК На высоком берегу'),
]
...
def determine_supplier2(supplier, parts, utm_source):
    ...
    # Словарь с правилами
    rules = {
        'Андрей': {'7p': 'andr_7p', '6p': 'andr_6p', '5p': 'andr_5p', '5.5p': 'andr_5.5p', '4p': 'andr_4p', 
        ...
        'Ноухау': {'newkval': 'knowhow_newkval', '16p': 'knowhow_16p', '8,5p': 'knowhow_8,5p', **{k: 'knowhow_0p' for k in zero_price}},
...
def determine_project2(project, parts):
    ...
    if matches:
        ...
        elif project == 'Перевод звонка' and project2 not in {'Мытищи', 'Санкт-Петербург', 'Москва',
                                                              'Ногинск', 'Клин', 'Хотьково', 'Дубна', 'Наро-Фоминск',
                                                              'Выборг', 'Кировск', 'Коммунар'}:
            ...
            if is_yandex:
                if project2 in {'Москва', 'Санкт-Петербург'}:
                    ...
                    project2 = 'Яндекс Т1'
                                ...
                                'Тула', 'Ижевск', 'Пермь', 'Хабаровск', 'Архангельск', 'Адыгея', 'Крым', 'Астрахань'}:
                    project2 = 'Яндекс Т2'
 
        elif project == 'Спецтехника' and project2 in {'Спецтехника аренда'}:
            project2 = 'Спецтехника аренда'          
